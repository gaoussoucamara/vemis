							        	...
							        	<table class="table table-hover table-striped table-bordered table-condensed">
					                        ...
					                        <c:forEach var="order" items="${hypothesesModele}"> 
											      <tr>
											         ...
											         <form:hidden path="numeroElement" name="numeroElement" id="numeroElement" class="form-control"/>
											         <td>
											         	<button type="submit" title="Supprimer cette hypothèse" class="btn btn-sm btn-danger" onclick="document.getElementById('numeroElement').value = '${order.numero}';" >
						                                        <i class="glyphicon glyphicon-remove"></i> Supprimer
						                                </button>                                					         
						                             </td>
											      </tr>
						...
						<div class="row">
							    <div class="col-sm-6">							      					        
							        ...
							        <button type="button" id="btnShowModalAddNewActivite" class="btn btn-sm btn-info" >
							            	<span class="glyphicon glyphicon-plus"></span>Ajouter une activité
							        	</button>				        							      
							    </div>							   
						</div>
                  </div>
