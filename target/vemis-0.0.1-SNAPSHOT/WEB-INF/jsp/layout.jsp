    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header bg-info">
          <h5 class="modal-title">Ajout d'une hypothèse</h5>
          	...
          	<div class="row">
	       		<div class="col-md-6">
                    <div class="form-group">
                        Nature:
                        <form:input path="natureHypothese" name="natureHypothese" id="natureHypothese" class="form-control"/>                                
                 	</div>
	            </div>
	            <div class="col-md-6">
                    <div class="form-group">
                        Porte sur:
                        <form:input path="quantificationHypothese" name="quantificationHypothese" id="quantificationHypothese" class="form-control"/>                                
                 	</div>
	            </div>
          	</div>
          	<div class="row">
	       		<div class="col-md-6">
                    <div class="form-group">
                        de l'élément:
                        <form:input path="elementDHypothese" name="elementDHypothese" id="elementDHypothese" class="form-control"/>                                
                 	</div>
	            </div>	            
          	</div>          	         
          </div>
